...
ActiveRecord::Schema.define(version: 20_211_116_231_547) do
  ...
  create_table 'reactions', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[reactionable_type reactionable_id], name: 'index_reactions_on_reactionable_type_and_reactionable_id'
